...
def parse_args():
    ...
    parser.add_argument('--pretrained_model_path', type=str, default="./example_ckpts/warmup_acm_xgoal.pkl",
    ...
    parser.add_argument('--k', type=list, default=[30, 5], help='the numbers of clusters')
    parser.add_argument('--tau', type=list, default=[0.02, 1], help='the temperature of clusters')
    ...
    parser.add_argument('--warmup_w_reg_n', type=float, default=1e-4, help='weight for node level alignment regularization')
...
def evaluate(path="./example_ckpts/acm_xgoal.pkl"):
    args, unknown = parse_args()
    printConfig(args)
